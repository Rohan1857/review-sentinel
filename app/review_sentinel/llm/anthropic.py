...
from review_sentinel.llm.provider import (
    ContextLengthError,
    MissingProviderError,
    ProviderError,
    RateLimitError,
)
from review_sentinel.llm.registry import INSTALL_INSTRUCTIONS
...
if TYPE_CHECKING:
    ...
    AnthropicToolChoice = ToolChoiceAnyParam | ToolChoiceAutoParam
...
TOOL_CHOICE_MAP: dict[ToolChoice, AnthropicToolChoice] = {

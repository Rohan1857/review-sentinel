...
from review_sentinel.config.agent import AgentConfig
...
class WorkspaceConfig(BaseModel):
    ...
    base_dir: Path = Path(tempfile.gettempdir()) / "review-sentinel"
...
def parse_title_tags(tags: str) -> frozenset[str]:
    ...
    Args:
        tags (str): Comma-separated tag names (e.g. ``"review_sentinelbot, CI"``).

...
├── prompts.py       # Guideline loading (.review_sentinel/ overrides), language detection, system prompt composition
...
- Guideline priority: repo `.review_sentinel/guidelines.md` replaces (not appends to) built-in defaults.

...
if TYPE_CHECKING:
    from review_sentinel.config.settings import GitHubConfig

import httpx

from review_sentinel.config.settings import DEFAULT_GITHUB_API_BASE
from review_sentinel.models import ChangedFile, EventType, FileStatus, ReviewFinding
...
from review_sentinel.platforms.github.auth import (
    NO_INSTALLATION,
    GitHubAppAuth,
    GitHubPatAuth,
)
from review_sentinel.platforms.http import request_with_retry
...
class GitHubPlatform:
    ...
    async def _request(
        ...
        **kwargs: Any,
        ...
        :func:`~review_sentinel.platforms.http.request_with_retry`.

...
from review_sentinel.platforms.base import Platform, PlatformAuth, PlatformName
from review_sentinel.platforms.github.platform import create_github_platform
from review_sentinel.platforms.gitlab.platform import create_gitlab_platform

if TYPE_CHECKING:
    from review_sentinel.config.settings import Config

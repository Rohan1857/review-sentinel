...
from review_sentinel.commands.webhook.jobs.dispatch import JobResult
from review_sentinel.commands.webhook.jobs.main import run_job_main
...
class TestRunJobMain:
    ...
    async def test_successful_reviewer_job(self, monkeypatch):
        ...
        with (
            patch(
                "review_sentinel.commands.webhook.jobs.main.build_platform",
                return_value=mock_platform,
            ),
            patch(
                "review_sentinel.commands.webhook.jobs.main.execute_job",
...
class TestPublishCompletion:
    ...
    async def test_publishes_succeeded_on_success(self, monkeypatch):
        ...
        with (
            ...
            patch(
                "review_sentinel.commands.webhook.jobs.main.build_conversation_store",
            ...
            patch(
                "review_sentinel.commands.webhook.jobs.main.publish_job_completion",
            ) as mock_publish,
        ):
            result = await run_job_main()

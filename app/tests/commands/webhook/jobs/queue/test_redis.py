...
from review_sentinel.commands.webhook.jobs.queue.redis import (
    RedisJobQueue,
    _build_queue_key,
)
...
class TestBuildQueueKey:
    def test_format(self):
        ...
        assert key == "nc:queue:github:owner/repo:42"
    ...
    def test_same_pr_produces_same_key(self):
        key_a = _build_queue_key(_make_job(pr_number=42))
        key_b = _build_queue_key(_make_job(pr_number=42))

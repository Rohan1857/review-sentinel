...
from review_sentinel.config.settings import GitLabConfig
from review_sentinel.models import DiffSide, EventType, FileStatus, ReviewFinding
...
from review_sentinel.platforms.gitlab.platform import (

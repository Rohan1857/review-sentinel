...
from review_sentinel.models import EventType, FileStatus, ReviewFinding
...
from review_sentinel.platforms.github import (
    GitHubPatAuth,
    GitHubPlatform,
)
from review_sentinel.platforms.github.platform import (
...
class TestFactory:
    ...
    def test_factory_returns_app_auth_when_app_id_and_key_set(self):
        from review_sentinel.platforms.github import GitHubAppAuth

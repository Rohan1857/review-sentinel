...
from review_sentinel.agent.api.runner import run_api_agent
...
from review_sentinel.llm.messages import (
    LLMResponse,
    Message,
    StopReason,
    TextBlock,
...
from review_sentinel.models import ErrorType, EventType, InvocationError, ProviderName
...
class TestRunAgentApi:
    ...
    async def test_provider_error_returns_error_result(self, tmp_path):
        from review_sentinel.llm.provider import ProviderError
...
class TestCompactionIntegration:
    ...
    async def test_compaction_skipped_when_notes_empty(self, tmp_path):
        ...
        with patch(
            "review_sentinel.agent.api.runner.execute_tool",
...
class TestAgentToolDispatch:
    ...
    async def test_parallel_agent_calls_run_concurrently(self, tmp_path):
        ...
        with patch(
            "review_sentinel.agent.api.runner._handle_agent_tool",

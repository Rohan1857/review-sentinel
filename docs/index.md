...
- **Per-repo guidelines** — coding standards via `.review_sentinel/guidelines.md` and `.review_sentinel/languages/{lang}.md`
...
- :material-account-group: **[Sub-Agents](reference/explore.md)** — on-demand explore sub-agents, WriteNotes, Agent tool
...
ReviewSentinel includes webhook signature verification, tool restrictions, token separation, and resource limits. See the **[Security](security.md)** page for the full trust model, LLM prompt injection risks, and hardening recommendations.

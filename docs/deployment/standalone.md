...
```
INFO  Starting server on 0.0.0.0:8080 | platforms=['github'] | reviewer=@review_sentinelbot | runner=in-process | allowed_users=frozenset({'alice', 'bob'})
...
```
@review_sentinelbot please review this PR
```

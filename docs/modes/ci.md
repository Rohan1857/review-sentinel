...
```yaml
- uses: Rohan1857/review-sentinel@0.1.0
```
...
=== "Anthropic (default)"
    ...
    ```yaml
    include:
      - remote: "https://raw.githubusercontent.com/Rohan1857/review-sentinel/main/ci/templates/gitlab-ci.yml"
...
2. `review-sentinel ci {platform}` loads the platform-specific CI module (`commands/ci/github.py` or `commands/ci/gitlab.py`).

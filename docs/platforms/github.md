...
ReviewSentinel supports two authentication methods for GitHub: a **Personal Access Token (PAT)** or a **GitHub App**. When both are configured, the GitHub App takes precedence.

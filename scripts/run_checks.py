...
CHECKS: list[tuple[str, list[str], Path]] = [
    ("ruff format", ["uv", "run", "ruff", "format", "--check", "review_sentinel/", "tests/"], APP_DIR),
    ("ruff check", ["uv", "run", "ruff", "check", "review_sentinel/", "tests/"], APP_DIR),
    ("mypy", ["uv", "run", "mypy", "review_sentinel/"], APP_DIR),
